...
urlpatterns = [
    ...
    path('update/<int:pk>', UsuariosUpdateAPIView.as_view(), name='usuarios-update'),
    path('cambiar-contrasena/<int:pk>', UsuarioCambContrasennaAPIView.as_view(), name='usuarios-cambiar-contrasena'),
